      ...
      <div className="info-main">
        ...
        <div className="product-quantity">
          <div className="minus-quantity" onClick={isMinus}>
            <img src={`${process.env.PUBLIC_URL}/assets/cart/minus-icon.svg`} alt="-" />
          </div>
          <input type="text" value={quantity} className="current-quantity" readOnly />
          <div className="plus-quantity" onClick={isPlus}>
            <img src={`${process.env.PUBLIC_URL}/assets/cart/plus-icon.svg`} alt="+" />
          </div>
        </div>
        ...
        <div className="coupon-block">
          <div className="select-coupon">
            ...
            <div className="select-icon">
              <img src={`${process.env.PUBLIC_URL}/assets/cart/select-icon.svg`} alt="select-icon" />
            </div>
