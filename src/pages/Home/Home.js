    ...
    <div className="home">
      ...
      <div className="refer">
        <div className="wrapper">
          <div className="block">
            <div className="icon">
              <img src={`${process.env.PUBLIC_URL}/assets/Home/warranty-icon.svg`} alt="2" />
            </div>
            <div className="context">Two years warranty</div>
          </div>
          <div className="block">
            <div className="icon">
              <img src={`${process.env.PUBLIC_URL}/assets/Home/shipping-icon.svg`} alt="배송비 무료" />
            </div>
            <div className="context">Free shipping</div>
          </div>
          <div className="block">
            <div className="icon">
              <img src={`${process.env.PUBLIC_URL}/assets/Home/return-icon.svg`} alt="30일 반품" />
            </div>
