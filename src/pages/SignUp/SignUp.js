        ...
        <div className="submit-block">
          <div className="submit-policy">
            <div className="check-box">
              <input type="radio" name="policy" value="policy" className="policy-context" />I have read and agree to the
              Privacy Policy
            </div>
          </div>
          <div className="select-subscribe">
            ...
            <div className="check-block">
              <div className="check-box">
                <input type="radio" name="check" value="1" className="context" checked />
                Yes
              </div>
            </div>
            <div className="check-block">
              <div className="check-box" name="check" value="2">
                <input type="radio" name="check" value="2" className="context" />
                No
              </div>
            </div>
          </div>
