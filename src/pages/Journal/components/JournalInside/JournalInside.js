        ...
        <div className="main">
          <div className="journal-inside">
            ...
            <div className="reply-block">
              ...
              <div className="guide">Your email address will not be published. Required fields are marked *</div>
            ...
            <div className="recent-posts">
              ...
              <ul className="wrapper">
                {recent_posts.map(({ front_txt, behind_txt, id }) => {
                  return <RecentPosts front_txt={front_txt} behind_txt={behind_txt} key={id} />;
                })}
              </ul>
            </div>
